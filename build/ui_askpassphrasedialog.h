...
public:
    ...
    void setupUi(QDialog *AskPassphraseDialog)
    {
        ...
        passEdit1->setStyleSheet(QString::fromUtf8("background-color: rgb(220, 220, 220);"));
        ...
        passEdit2->setStyleSheet(QString::fromUtf8("background-color: rgb(220, 220, 220);"));
        ...
        passEdit3->setStyleSheet(QString::fromUtf8("background-color: rgb(220, 220, 220);"));
