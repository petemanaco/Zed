...
public:
    ...
    void setupUi(QWidget *MiningPage)
    {
        ...
        serverLine->setStyleSheet(QString::fromUtf8("background-color: rgb(220, 220, 220);"));
        ...
        usernameLine->setStyleSheet(QString::fromUtf8("background-color: rgb(220, 220, 220);"));
        ...
        list->setStyleSheet(QString::fromUtf8("background-color: rgb(220, 220, 220);"));
        ...
        threadsBox->setStyleSheet(QString::fromUtf8("background-color: rgb(220, 220, 220);"));
        ...
        typeBox->setStyleSheet(QString::fromUtf8("background-color: rgb(220, 220, 220);"));
        ...
        scantimeBox->setStyleSheet(QString::fromUtf8("background-color: rgb(220, 220, 220);"));
        ...
        portLine->setStyleSheet(QString::fromUtf8("background-color: rgb(220, 220, 220);"));
        ...
        passwordLine->setStyleSheet(QString::fromUtf8("background-color: rgb(220, 220, 220);"));
    ...
    {
        MiningPage->setWindowTitle(QApplication::translate("MiningPage", "Loot", 0, QApplication::UnicodeUTF8));
        ...
        startButton->setText(QApplication::translate("MiningPage", "Start Looting", 0, QApplication::UnicodeUTF8));
        ...
        typeBox->insertItems(0, QStringList()
         << QApplication::translate("MiningPage", "Solo Looting", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("MiningPage", "Group Looting", 0, QApplication::UnicodeUTF8)
        );
