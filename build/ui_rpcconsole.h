...
public:
    ...
    void setupUi(QDialog *RPCConsole)
    {
        ...
        messagesWidget->setStyleSheet(QString::fromUtf8("background-color: rgb(220, 220, 220);"));
    ...
    {
        RPCConsole->setWindowTitle(QApplication::translate("RPCConsole", "ZedCoin - Debug window", 0, QApplication::UnicodeUTF8));
        ...
        openDebugLogfileButton->setToolTip(QApplication::translate("RPCConsole", "Open the ZedCoin debug logfile from the current data directory. This can take a few seconds for large logfiles.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        showCLOptionsButton->setToolTip(QApplication::translate("RPCConsole", "Show the ZedCoin-Qt help message to get a list with possible ZedCoin command-line options.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
