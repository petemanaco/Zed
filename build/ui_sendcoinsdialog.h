...
public:
    ...
    void setupUi(QDialog *SendCoinsDialog)
    {
        ...
        scrollArea->setStyleSheet(QString::fromUtf8("background-color: rgb(220, 220, 220);"));
        scrollArea->setWidgetResizable(true);
        scrollAreaWidgetContents = new QWidget();
        scrollAreaWidgetContents->setObjectName(QString::fromUtf8("scrollAreaWidgetContents"));
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 664, 138));
    ...
    void retranslateUi(QDialog *SendCoinsDialog)
    {
        ...
        labelBalance->setText(QApplication::translate("SendCoinsDialog", "123.456 ZED", 0, QApplication::UnicodeUTF8));
#ifndef QT_NO_TOOLTIP
