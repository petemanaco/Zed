...
public:
    ...
    void setupUi(QFrame *SendCoinsEntry)
    {
        ...
        payAmount->setStyleSheet(QString::fromUtf8("background-color: rgb(220, 220, 220);"));
        ...
        addAsLabel->setStyleSheet(QString::fromUtf8("background-color: rgb(220, 220, 220);"));
        ...
        payTo->setStyleSheet(QString::fromUtf8("background-color: rgb(220, 220, 220);"));
